                                        ...
                                        {isWeb3Enabled && (
                                            <div className="border-t border-border pt-4 mb-8">
                                                ...
                                                <div className="font-medium text-xl text-red-500">
                                                    {`Performance Impact: ${Math.round((stats.rawTypingTime! > 0 ? stats.blockchainOverhead / stats.rawTypingTime! : 0) * 100)}% slower`}
                                                </div>
                                                ...
                                                <table className="w-full">
                                                    ...
                                                    <tbody>
                                                        {wordResults.map((result, index) => {
                                                            const impactPercentage = Math.round((result.blockchainTimeMs / result.typingTimeMs) * 100);
                                                            return (
